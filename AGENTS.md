...
3. Read the relevant workflow docs, especially `docs/06_betriebsmanual_workflow.md`.
4. Follow the repository rules for documentation, Git usage, verification, and
   reporting.
